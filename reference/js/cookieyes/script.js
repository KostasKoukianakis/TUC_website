!function() {
    var e = {
            ...
            "document"in window.self && ((!("classList"in document.createElement("_")) || document.createElementNS && !("classList"in document.createElementNS("http://www.w3.org/2000/svg", "g"))) && function(e) {
                ...
                if ("Element"in e) {
                    var t = "classList"
                      ...
                      , u = function(e) {
                        for (var t = i.call(e.getAttribute("class") || ""), r = t ? t.split(/\s+/) : [], o = 0, n = r.length; o < n; o++)
                            this.push(r[o]);
                    ...
                    ,
                    l.add = function() {
                        var e, t = arguments, r = 0, o = t.length, n = !1;
                        do {
                            -1 === c(this, e = t[r] + "") && (this.push(e),
                            n = !0)
                        } while (++r < o);
                    ...
                    ,
                    l.remove = function() {
                        var e, t, r = arguments, o = 0, n = r.length, i = !1;
                        do {
                    ...
                    n.defineProperty) {
                        ...
                        n[r].__defineGetter__ && o.__defineGetter__(t, d)
                }
            }(window.self),
            function() {
                "use strict";
        ...
        237: function() {
            ...
            function o(e, o) {
                ...
                t(o) ? (s.setRequestHeader("Content-Type", "text/plain;charset=UTF-8"),
                s.responseType = "text") : r(o) && o.type && s.setRequestHeader("Content-Type", o.type);
                try {
                    s.send(o)
                } catch (e) {
                    return !1
            ...
            (function() {
                ...
                "function" != typeof this.navigator.sendBeacon && (this.navigator.sendBeacon = o.bind(this))
            }
        ...
        147: function(e, t, r) {
            ...
            function p() {
                ...
                this._initBody = function(e) {
                    ...
                    this._bodyInit = e,
                    e ? "string" == typeof e ? this._bodyText = e : n.blob && Blob.prototype.isPrototypeOf(e) ? this._bodyBlob = e : n.formData && FormData.prototype.isPrototypeOf(e) ? this._bodyFormData = e : n.searchParams && URLSearchParams.prototype.isPrototypeOf(e) ? this._bodyText = e.toString() : n.arrayBuffer && n.blob && ((t = e) && DataView.prototype.isPrototypeOf(t)) ? (this._bodyArrayBuffer = y(e.buffer),
                    this._bodyInit = new Blob([this._bodyArrayBuffer])) : n.arrayBuffer && (ArrayBuffer.prototype.isPrototypeOf(e) || s(e)) ? this._bodyArrayBuffer = y(e) : this._bodyText = e = Object.prototype.toString.call(e) : (this._noBody = !0,
                    this._bodyText = ""),
            ...
            function k(e, t) {
                return new Promise((function(r, i) {
                    ...
                    if (u.onload = function() {
                        ...
                        0 === s.url.indexOf("file://") && (u.status < 200 || u.status > 599) ? o.status = 200 : o.status = u.status,
                    ...
                    "responseType"in u && (n.blob ? u.responseType = "blob" : n.arrayBuffer && (u.responseType = "arraybuffer")),
                    t && "object" == typeof t.headers && !(t.headers instanceof l || o.Headers && t.headers instanceof o.Headers)) {
                        var f = [];
                    ...
                    s.signal && (s.signal.addEventListener("abort", d),
    ...
    Element.prototype.toggleAttribute || (Element.prototype.toggleAttribute = function(e, t) {
        return void 0 !== t && (t = !!t),
        this.hasAttribute(e) ? !!t || (this.removeAttribute(e),
    ...
    function() {
        if (!function() {
            try {
                const e = {
                    registeredDomain: "www.worldquantfoundry.com",
        ...
        if (!!(!window.cookieyes || !window.cookieyes._ckyStore)) {
            ...
            const r = window.cookieyes;
            r._ckyGetCookieMap = function() {
                const e = {};
                try {
            ...
            ,
            r._ckySetCookie = function(e, t) {
                let o = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : 0
                  , n = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : r._ckyStore._rootDomain;
                const i = new Date
                  , s = 0 === o ? 0 : i.setTime(i.getTime() + 24 * o * 60 * 60 * 1e3)
                  , a = new Date(s).toUTCString()
                  , c = window.ckySettings?.iframeSupport ? "None" : "Strict";
                document.cookie = `${e}=${t}; expires=${a}; path=/;domain=${n}; SameSite=${c}; secure`
            }
            ,
            r._ckyRandomString = function(e) {
                let t = !(arguments.length > 1 && void 0 !== arguments[1]) || arguments[1];
                const r = (t ? "0123456789" : "") + "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghiklmnopqrstuvwxyz"
                  , o = [];
                for (let t = 0; t < e; t++)
            ...
            ,
            r._ckyIsCategoryToBeBlocked = function(e) {
                const t = r._ckyGetFromStore(e);
                return "no" === t || !t && r._ckyStore._categories.some((t => t.slug === e && !t.isNecessary))
            }
            ,
            r._ckyEscapeRegex = function(e) {
                return e.replace(/[.*+?^${}()[\]\\]/g, "\\$&")
            }
            ,
            r._ckyShouldBlockProvider = function(e) {
                const t = r._ckyStore._providersToBlock.find((t => {
                    let {url: o} = t;
                    return new RegExp(r._ckyEscapeRegex(o)).test(e)
                }
                ));
                return t && t.categories.some((e => r._ckyIsCategoryToBeBlocked(e)))
            }
            ,
            r._ckyStartsWith = function(e, t) {
                return e.slice(0, t.length) === t
            }
            ,
            r._ckyReplaceAll = function(e, t, o) {
                return e.replace(new RegExp(r._ckyEscapeRegex(t),"g"), o)
            }
            ,
            r._ckyStore = {
                _backupNodes: [],
                _categories: [{
                    ...
                    cookies: [{
                        cookieID: "_cfuvid",
                        domain: ".www.worldquantfoundry.com"
                    }]
                }, {
                    slug: "functional",
                    isNecessary: !1,
            ...
            r._ckyConsentStore = new Map,
            r._ckyGetFromStore = function(e) {
                return r._ckyConsentStore.get(e) || ""
            }
            ;
            let o = r._ckyGetCookieMap();
            r._ckySetInStore = function(e, t) {
                r._ckyConsentStore.set(e, t);
                const o = [];
                for (const [e,t] of r._ckyConsentStore)
                    o.push(`${e}:${t}`);
                const n = r._ckyStore._bannerConfig && r._ckyStore._bannerConfig.scriptExpiry ? r._ckyStore._bannerConfig.scriptExpiry : 365;
                r._ckySetCookie("cookieyes-consent", o.join(","), n)
            }
            ;
            let n = (o["cookieyes-consent"] || "").split(",").reduce(( (e, t) => {
                if (!t)
                    return e;
                const [r,o] = t.split(":");
                return e[r] = o,
            ...
            ["consentid", "consent", "action"].concat(r._ckyStore._categories.map((e => {
                let {slug: t} = e;
                return t
            }
            ))).map((e => r._ckyConsentStore.set(e, n[e] || ""))),
            r._ckySendPageViewLog = function(e) {
                let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "";
                try {
                    const o = {
                        consent_session_id: r._ckyGetFromStore("consentid"),
                        banner_id: t
                    }
                      , n = new FormData;
                    n.append("key", "e13805ca0237c863c297140fa9f82f7e"),
            ...
            ,
            function() {
                if (r._ckyGetFromStore("consentid"))
                    return;
                const e = r._ckyRandomString(32);
                r._ckySetInStore("consentid", e),
                r._ckyStore._resetConsentID = !0
            }(),
            r._ckySendPageViewLog("banner_load");
            try {
                r._ckyCreateElementBackup = document.createElement,
                document.createElement = function() {
                    for (var e = arguments.length, o = new Array(e), n = 0; n < e; n++)
                        o[n] = arguments[n];
                    const i = r._ckyCreateElementBackup.call(document, ...o);
                    if ("script" !== i.nodeName.toLowerCase())
                        return i;
                    ...
                    return Object.defineProperties(i, {
                        src: {
                            ...
                            set: function(e) {
                                return t(i, e) && s("type", "javascript/blocked"),
                                s("src", e),
                                !0
                            },
                            configurable: !0
                        ...
                        type: {
                            ...
                            set: function(e) {
                                return e = t(i) ? "javascript/blocked" : e,
                                s("type", e),
                                !0
                            },
                            configurable: !0
                    ...
                    i.setAttribute = (e, r) => {
                        if ("type" === e || "src" === e)
                            return i[e] = r;
                        s(e, r),
                        "data-cookieyes" !== e || t(i) || s("type", "text/javascript")
                    }
                    ,
                    i
                }
            ...
            function e(t) {
                if (t.nodeName)
                    if (["script", "iframe"].includes(t.nodeName.toLowerCase()))
                        !function(e) {
                            try {
                                const t = r._ckyStartsWith(e.src, "//") ? `${window.location.protocol}${e.src}` : e.src
                                  , {hostname: o, pathname: n} = new URL(t)
                                  , i = `${o}${n}`.replace(/^www./, "");
                                if (function(e, t) {
                                    ...
                                    for (const e of r._ckyStore._categories)
                                        if (e.isNecessary && e.slug === n)
                                            return;
                                    const i = r._ckyStore._providersToBlock.find((e => {
                                        let {url: r} = e;
                                        return r === t
                                    }
                                    ));
                                    i ? i.isOverriden ? i.categories.includes(n) || i.categories.push(n) : (i.categories = [n],
                                    i.isOverriden = !0) : r._ckyStore._providersToBlock.push({
                                        url: t,
                                        categories: [n],
                                        fullPath: !1
                                    })
                                }(e, i),
                                !r._ckyShouldBlockProvider(i))
                                    return;
                                const s = r._ckyRandomString(8, !1);
                                if ("iframe" === e.nodeName.toLowerCase())
                                    !function(e, t) {
                                        let {offsetWidth: r, offsetHeight: o} = e;
                                        if (0 === r || 0 === o) {
                                            if (({offsetWidth: r, offsetHeight: o} = function(e) {
                                            ...
                                            r = `${r}px`,
                                            o = `${o}px`;
                                        e.insertAdjacentHTML("afterend", '<div class="video-placeholder-normal" data-cky-tag="video-placeholder" id="[UNIQUEID]"><p class="video-placeholder-text-normal" data-cky-tag="placeholder-title">[cky_video_placeholder_title]</p></div>'.replace("[UNIQUEID]", t));
                                    ...
                                    r._ckyStore._bannerAttached && r._ckySetPlaceHolder && r._ckySetPlaceHolder(s);
                                else {
                    ...
                    else if (t.childElementCount > 0 && "noscript" !== t.nodeName.toLowerCase())
                        for (const r of t.childNodes)
                            e(r)
            }
            function t(e, t) {
                return e.hasAttribute("data-cookieyes") && r._ckyIsCategoryToBeBlocked(e.getAttribute("data-cookieyes").replace("cookieyes-", "")) || r._ckyShouldBlockProvider(t || e.src)
            }
            r._nodeListObserver = new MutationObserver((function(t) {
                for (const {addedNodes: r} of t)
                    for (const t of r)
                        e(t)
            }
            )),
            r._nodeListObserver.observe(document.documentElement, {
                childList: !0,
                subtree: !0
            });
            const i = document.createElement("script");
            i.src = "https://cdn-cookieyes.com/client_data/e13805ca0237c863c297140fa9f82f7e/banner.js",
            i.async = !0,
